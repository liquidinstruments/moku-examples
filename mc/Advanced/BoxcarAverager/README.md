...
This simple design is written directly in VHDL with hard-coded parameters. For a more featureful version that requires HDL Coder, see [HDL Coder Boxcar](https://github.com/liquidinstruments/moku-examples/tree/main/mc/HDLCoder/hdlcoder_boxcar).
