...
ENTITY DSP IS
  PORT( Clk                               :   IN    std_logic;
        ...
        TriggerDelay_0                    :   IN    signed(31 DOWNTO 0);  -- int32
        ...
        TriggerDelayBaseline_0            :   IN    signed(31 DOWNTO 0);  -- int32
        FlagSwitch                        :   IN    std_logic;
        TriggerDelay_1                    :   IN    signed(31 DOWNTO 0);  -- int32
        GateWidth_1                       :   IN    signed(15 DOWNTO 0);  -- int16
        AvgLength_1                       :   IN    signed(15 DOWNTO 0);  -- int16
        TriggerDelayBaseline_1            :   IN    signed(31 DOWNTO 0);  -- int32
...
ARCHITECTURE rtl OF DSP IS
  ...
  COMPONENT Dual_Averager_0
    PORT( Clk                             :   IN    std_logic;
          ...
          TriggerDelay                    :   IN    unsigned(31 DOWNTO 0);  -- uint32
          GateLength                      :   IN    unsigned(15 DOWNTO 0);  -- uint16
          TriggerDelayBaseline            :   IN    unsigned(31 DOWNTO 0);  -- uint32
  ...
  SIGNAL Convertor_Control6_out1          : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL Convertor_Control7_out1          : unsigned(15 DOWNTO 0);  -- uint16
  SIGNAL Convertor_Control9_out1          : unsigned(31 DOWNTO 0);  -- uint32
  ...
  SIGNAL Convertor_Control1_out1          : unsigned(31 DOWNTO 0);  -- uint32
  SIGNAL Convertor_Control2_out1          : unsigned(15 DOWNTO 0);  -- uint16
  SIGNAL Convertor_Control4_out1          : unsigned(31 DOWNTO 0);  -- uint32
...
BEGIN
  ...
  u_Dual_Averager_1 : Dual_Averager_0
    PORT MAP( Clk => Clk,
              ...
              TriggerDelay => Convertor_Control6_out1,  -- uint32
              GateLength => Convertor_Control7_out1,  -- uint16
              TriggerDelayBaseline => Convertor_Control9_out1,  -- uint32
  ...
  u_Dual_Averager_0 : Dual_Averager_0
    PORT MAP( Clk => Clk,
              ...
              SignalInput => Delay1_out1,  -- int16
              Trigger => Detect_Rise_Positive_out1,
              TriggerDelay => Convertor_Control1_out1,  -- uint32
              GateLength => Convertor_Control2_out1,  -- uint16
              TriggerDelayBaseline => Convertor_Control4_out1,  -- uint32
