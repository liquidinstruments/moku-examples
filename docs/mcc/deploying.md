...
1. Configure **Hardware version**, **Number of slots**, and **Firmware version** (up to 8 slots for Moku:Delta, 4 slots for Moku:Pro, and 2 slots for Moku:Go and Moku:Lab)
