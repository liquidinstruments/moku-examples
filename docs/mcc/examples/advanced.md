...
This simple design is written directly in VHDL with hard-coded parameters. For a more featureful version that requires HDL Coder, see [HDL Coder Boxcar](./hdlcoder) or our [example projects](https://github.com/liquidinstruments/moku-examples/tree/main/mcc/HDLCoder/)
