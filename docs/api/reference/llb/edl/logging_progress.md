...
::: tip INFO
To convert .li binary formatted log files, use liconverter windows app or [mokucli convert](../../../../cli/moku-cli#mokucli-convert)
:::
...
$: curl -H 'Moku-Client-Key: <key>'\
        ...
        --data '{}'\
        http://<ip>/api/laserlockbox/logging_progress
```
...
{
   "complete":False,
   "file_name":"MokuFIRFilterBoxData_20210603_101533.li",
   "running":True,
   "samples_logged":2238,
   "time_remaining":2
}
