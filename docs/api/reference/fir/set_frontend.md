...
# Set Input 1 to 1 MOhm, DC coupled, 20 dB attenuation, 300 MHz bandwidth
...
% Set Input 1 to DC coupling, 1 MOhm impedance, 20 dB attenuation and 300 MHz bandwidth
