...
additional_doc: null
deprecated: true
deprecated_msg: This method is deprecated and will be removed soon. Please use **hysteresis** parameter in [set_trigger](./set_trigger.md)
...
$: curl -H 'Moku-Client-Key: <key>'\
        ...
        http://<ip>/api/firfilter/set_hysteresis
```
