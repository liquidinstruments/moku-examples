...
additional_doc: null
deprecated: true
deprecated_msg: This method is deprecated and will be removed soon. Please use [set_output_termination](./set_output_termination.html)
...
$: curl -H 'Moku-Client-Key: <key>'\
        ...
        http://<ip>/api/waveformgenerator/set_output_load
```
