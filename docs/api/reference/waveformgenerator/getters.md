---
additional_doc: Along with regular configuration methods, Waveform Generator supports following getter functions.
name: getters
description: Waveform Generator - getter functions
getters: 
