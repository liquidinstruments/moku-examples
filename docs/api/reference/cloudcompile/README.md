---
title: Cloud Compile Instrument
prev: false
---

# Moku Cloud Compile Instrument

Provides access to Cloud Compile Instrument generated with [Moku Cloud Compile](https://www.liquidinstruments.com/moku-cloud-compile/)
...
Moku Cloud Compile instruments can only be used in Multi-instrument Mode. Refer to the [Multi-instrument Mode Getting Started Guide](../../getting-started/starting-mim.md) for more details.
:::
