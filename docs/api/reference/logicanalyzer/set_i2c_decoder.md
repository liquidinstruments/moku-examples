...
i.set_pin(2, "PG1")
i.set_i2c_decoder(1, data_bit=1, clock_bit=2)
```
...
m.set_pin(2, "PG1");
m.set_i2c_decoder(1, 'data_bit', 1, 'clock_bit', 2);
```
...
$: curl -H 'Moku-Client-Key: <key>'\
        ...
        --data '{"channel":1, "data_bit":1, "clock_bit":2}'\
        http://<ip>/api/logicanalyzer/set_i2c_decoder
```
