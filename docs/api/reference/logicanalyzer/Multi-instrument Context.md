...
-   cURL: `http://<ip>/api/<slot>/logicanalyzer`
...
::: warning
Multi-instrument mode should be enabled before configuring Lock-in Amplifier in one of the slots. Read [Platform](../moku/platform)
:::
