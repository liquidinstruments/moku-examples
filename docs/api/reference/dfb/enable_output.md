---
additional_doc:
    The Digital Filter Box instrument has an output stage between the filter itself and the
...
# Configure the Channel 1 filter
i.set_filter(1, sample_rate='3.906MHz', shape="Lowpass",
                 type="Butterworth",
                 order=8)
...
% Configure the Channel 1 filter
m.set_filter(1, 'sample_rate', '3.906MHz', 'shape', 'Lowpass',
                 'type', 'Butterworth', 'order', 8);
