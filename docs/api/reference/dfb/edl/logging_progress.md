...
::: tip INFO
To convert .li binary formatted log files, use liconverter windows app or [mokucli convert](../../../../cli/moku-cli#mokucli-convert.md)
:::
...
$: curl -H 'Moku-Client-Key: <key>'\
        ...
        --data '{}'\
        http://<ip>/api/digitalfilterbox/logging_progress
```
