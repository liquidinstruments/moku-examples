...
additional_doc: null
description:
    Configures the specified monitor channel to view the desired digital filter
    signal.
method: post
name: set_monitor
parameters:
    ...
    - default: null
      ...
      param_range:
          ...
          mokudelta: None, Input1, Filter1, Output1, Input2, Filter2, Output2, Input3, Filter3, Output3, Input4, Filter4, Output4
      type: string
      unit: null
    - default: true
