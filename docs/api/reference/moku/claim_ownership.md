...
This operation is called implicitly from Python and MATLAB libraries when the instrument objects are created. The user only needs to call this themselves if they're using the REST API directly. Refer to the [REST Getting Started Guide](../../getting-started/starting-curl.md) for more information.
:::
