...
parameters:
    - default:
      ...
      param_range:
          ...
          mokupro: Source [Input1, Input2, Input3, Input4, SlotXOutY]; Destination [Output1, Output2, Output3, Output4, SlotXInY]
          mokudelta: Source (Input1, Input2, Input3, Input4, Input5, Input6, Input7, Input8, DIO, SlotXOutY); Destination (Output1, Output2, Output3, Output4, Output5, Output6, Output7, Output8, DIO, SlotXInY)
      type: array
      unit: null
...
:::tip Incremental Use
The connection action is _incremental_. That is, each connection specified in this function is made in addition to (or in replacement of) an existing connection. There is no way to remove a connection except by replacing it with something else.
:::
