...
This method returns the data in the LI binary format. If you are using Python or MATLAB package use [get_stream_data](./get_stream_data) to get the converted stream
