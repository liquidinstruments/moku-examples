<template>
  <div v-if="$frontmatter.path_parameters.length">
    <h3>Path parameters</h3>
    <section class="parameters-section">
      <div v-for="p in $frontmatter.path_parameters">
        <div class="param-container" :id="'param-' + p.name">
          <div class="Parameter-module--padded--1K5Kq">
            <div class="Title-module--title--16rrq">
              <label><a :href="'#param-' + p.name" data-display-anchor="true">{{p.name}}</a>
              </label>
            ...
            <div class="Detail-module--details--3v0Zg" v-if="p.default !== null">
              <code v-if="p.default === ''">default: ""</code>
              <code v-else>default: {{ p.default }}</code>
            </div>
            <div class="Detail-module--details--3v0Zg" v-if="p.param_range !== null">
              <parameter-range :range='p.param_range'></parameter-range>
            </div>
            <div class="Detail-module--details--3v0Zg" v-if="p.unit !== null">
