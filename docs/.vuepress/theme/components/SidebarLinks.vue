  ...
  >
    ...
    >
      ...
      <SidebarLink
        ...
        :item="item"
      />
      <warn-go class="badge-sidebar" v-if="typeof item.frontmatter !== 'undefined' && item.frontmatter.available_on === 'mokugo'"/>
      <warn-pro class="badge-sidebar" v-if="typeof item.frontmatter !== 'undefined' && item.frontmatter.available_on === 'mokupro'"/>
    </li>
  </ul>
</template>
