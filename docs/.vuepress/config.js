        ...
        sidebar: {
            ...
            '/mcc/': [
                ...
                },
                {
                    ...
                    initialOpenGroupIndex: -1,
                    children: [
                        ['/mcc/examples/', 'Examples'],
                        ['/mcc/examples/advanced', 'Advanced'],
                        ['/mcc/examples/basic', 'Servo Driver'],
                        ['/mcc/examples/hdlcoder', 'Digital I/O'],
                        ['/mcc/examples/moderate', 'DC Sequencer'],
                        ['/mcc/examples/template', 'Event Counter'],
                    ],
                },
            ],
            '/cli/': [
