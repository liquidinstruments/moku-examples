...
**Step 5:** Select "Set an API key" and paste the key that was copied earlier to load all the projects associated with the
account and the bitstreams available on each project. Select the compatible bitstream to upload onto your Moku device.
