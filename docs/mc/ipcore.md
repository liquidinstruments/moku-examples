...
The instantiation templates for the IP cores are available in the [GitHub repository](https://github.com/liquidinstruments/moku-examples/tree/main/mcc/IP%20Core%20Templates%20and%20Examples) with support for both VHDL and Verilog.
