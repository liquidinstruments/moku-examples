...
try
    ...
    logging_request = m.start_logging('duration',10, 'sample_rate',1e3);
    ...
    % Moku:Go should be downloaded from "persist", Moku:Lab from "media",
    % and Moku:Delta and Moku:Pro from "ssd"
    m.download_file('persist',log_file,['C:\Users\' log_file]);
