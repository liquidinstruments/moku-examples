...
try
    ...
    m.set_filter(1, "3.906MHz", 'shape',"Lowpass", 'type',"Butterworth",...
        'low_corner',1e3, 'order',8);
    m.set_filter(1, "3.906MHz", 'shape',"Highpass", 'type',"Elliptic",...
